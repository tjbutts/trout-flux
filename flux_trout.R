...
plot(flux_J_month~year, type = 'o', pch = 19, lwd =2, data = piscivory.flux, xlim = c(2001, 2020), xlab = '', ylab = '')
abline(v = 2007, lty = 2) 
abline(v = 2014, lty = 2)
...
plot(flux_yr~year, type = 'o', pch = 19, lwd =2, data = zooplanktivory.flux, xlim = c(2001, 2020), xlab = '', ylab = '')
abline(v = 2007, lty = 2) 
abline(v = 2014, lty = 2)
...
plot(flux_yr~year, type = 'o', pch = 19, lwd =2, data = pelagic.zoobenthivory.flux, xlim = c(2001, 2020), xlab = '', ylab = '')
abline(v = 2007, lty = 2) 
abline(v = 2014, lty = 2)
...
plot(flux_yr~year, type = 'o', pch = 19, lwd =2, data = byth.flux, xlim = c(2001, 2020), xlab = '', ylab = '')
abline(v = 2007, lty = 2) 
abline(v = 2014, lty = 2)
...
plot(total.yr~year, type = 'o', pch = 19, lwd =2, data = total.flux, xlim = c(2001, 2020), xlab = '', ylab = '')
abline(v = 2007, lty = 2) 
abline(v = 2014, lty = 2)
...
plot(stability~year, type = 'o', pch = 19, lwd = 2, data = stability.estimate_final, xlim = c(2001,2019), xlab = '', ylab = '')
mtext('Stability', side = 2, line = 2.8, cex = 1)
mtext('Year', side = 1, line = 2.8, cex = 1)
mtext('Food web stability', font = 2, cex = 1.5, side = 3, line = 0.1)
