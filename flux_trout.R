...
mat.02 = early.mat.b[-c(2:3),-c(2:3)]
mat.02
...
mat.03 = early.mat.b[-c(2:3),-c(2:3)]
mat.03
...
mat.04 = early.mat.b[-c(2:3),-c(2:3)]
mat.04
...
mat.05 = early.mat.b[-c(2:3),-c(2:3)]
mat.05
...
mat.06 = early.mat.b[-c(2:3),-c(2:3)]
mat.06
...
mat.14 = early.mat.b[-c(2:3),-c(2:3)]
mat.14
...
# Base Dataset Fluxes in J/year + Stability - Binary #===========================
outgoing.flux_final.b = bind_rows(outgoing01, outgoing02, outgoing03, outgoing04, outgoing05, outgoing06, outgoing07, 
...
stability.estimate_final.b = bind_rows(stab01, stab02, stab03, stab04, stab05, stab06, stab07, stab08, stab09,
...
mat.01 = early.mat.p[-c(2:3),-c(2:3)]
mat.01
...
mat.02 = early.mat.p[-c(2:3),-c(2:3)]
mat.02
...
mat.03 = early.mat.p[-c(2:3),-c(2:3)]
mat.03
...
mat.04 = early.mat.p[-c(2:3),-c(2:3)]
mat.04
...
mat.05 = early.mat.p[-c(2:3),-c(2:3)]
mat.05
...
mat.06 = early.mat.p[-c(2:3),-c(2:3)]
mat.06
...
mat.14 = early.mat.p[-c(2:3),-c(2:3)]
mat.14
