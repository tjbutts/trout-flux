...
binary_flux # didn't update 
binary_stability # didn't update 
...
flux.2.binary = binary_flux.long %>%
  ...
  group_by(year) %>% 
  summarize(flux_J_yr = sum(flux_J_yr)) %>%
  ungroup()
flux.2.binary
...
total.p = tfp %>% 
  pivot_longer(cols = pref.tf, 
               names_to = 'matrix', 
               values_to = 'total.flux')
total.p

min(total.p$total.flux)
max(total.p$total.flux)

windows(height = 3, width = 4)
library(ggplot2)
ggplot(total.p, aes(y = total.flux, x = year, fill = 'black')) + 
...
# 
# # Cisco -> fish # 
# plot(log(flux_J_yr)~year, type = 'o', pch = 19, lwd =2, col = f.1, ylim = c(log(90), log(300000000)), yaxt = 'n', 
...
# 
# # pMIV -> LT & CSC# 
# points(log(flux_J_yr)~year, type = 'o', pch = 15, lwd =2, col = f.2, cex = 2,
...
# #points(log(flux_J_yr) ~ year, data = zooplanktivory.flux, type = 'o', pch = 19, lwd = 1, col = 'gray50', xlab = '', ylab = '', lty = 2)
# 
# 
# # ZP -> CSC & pMIV # 
# points(log(flux_J_yr)~year, type = 'o', pch = 17, lwd =2, col = f.3, cex = 2,
...
# 
# # For uncorrected - must run base fluxes first # 
# #points(log(flux_J_yr) ~ year, data = pelagic.zoobenthivory.flux, type = 'o', pch = 19, lwd = 1, col = 'gray70', xlab = '', ylab = '', lty = 2)
# 
# # ZP -> CSC & pMIV & SWF # 
# points(log(flux_J_yr)~year, type = 'o', pch = 17, lwd = 2, col = f.4, cex = 2,
#        data = flux.4.binary, xlim = c(2001, 2019), xlab = '', ylab = '')
# 
# # Spiny -> CSC # 
# points(log(flux_J_yr)~year, type = 'o', pch = 18, lwd =2, col = f.5, cex = 2,
...
# 
# # For uncorrected - must run base fluxes first 
# #points(log(flux_J_yr) ~ year, data = byth.flux, type = 'o', pch = 19, lwd = 1, col = 'black', xlab = '', ylab = '', lty = 2)
# 
# 
...
# Cisco -> fish # 
plot(log(flux_J_yr)~year, type = 'o', pch = 19, lwd =2, col = f.1, ylim = c(log(1), log(300000000)), yaxt = 'n', 
     data = flux.1.preference, xlim = c(2001, 2022), xaxt = 'n',  
...
# pMIV -> LT & CSC# 
points(log(flux_J_yr)~year, type = 'o', pch = 15, lwd =2, col = f.2, cex = 2,
       data = flux.2.preference, xlim = c(2001, 2022), xlab = '', ylab = '')

# ZP -> CSC & pMIV # 
points(log(flux_J_yr)~year, type = 'o', pch = 17, lwd =2, col = f.3, cex = 2,
       data = flux.3.preference, xlim = c(2001, 2022), xlab = '', ylab = '')

# ZP -> CSC & pMIV & SWF # 
points(log(flux_J_yr)~year, type = 'o', pch = 17, lwd = 2, col = f.4, cex = 2,
       data = flux.4.preference, xlim = c(2001, 2022), xlab = '', ylab = '')

# Spiny -> CSC # 
points(log(flux_J_yr)~year, type = 'o', pch = 18, lwd =2, col = f.5, cex = 2,
       data = flux.5.preference, xlim = c(2001, 2022), xlab = '', ylab = '')
...
# Fluxweb preference stability plot #=========================

# Will plot stability with the Pomeranz/Sauve method #  
